    ...
    <nav className="bg-base-100/70 backdrop-blur-xl border-b border-base-300 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <Link
            to={"/problems"}
            className={`h-9 px-3 rounded-xl transition-all duration-200 shrink-0 flex items-center
            ${
              isActive("/problems")
          ...
          >
            <div className="flex items-center gap-2">
              <BookOpenIcon className="size-4.5" strokeWidth={2.1} />
          ...
          >
            <div className="flex items-center gap-2">
              <LayoutDashboardIcon className="size-4.5" strokeWidth={2.1} />
              <span className="font-medium hidden md:inline text-sm">
                Dashboard
              </span>
            </div>
          ...
          <Theme />
          <div className="h-9 w-9 rounded-xl border border-base-300 bg-base-200/70 flex items-center justify-center">
            <UserButton />
          </div>
        </div>
      </div>
